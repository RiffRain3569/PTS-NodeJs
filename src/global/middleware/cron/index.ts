...
export const cronMiddleware = () => {
    if (process.env.NODE_ENV === 'production') {
        ...
        hold_hour_bitget({ hour: 1, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 2, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        ...
        hold_hour_bitget({ hour: 5, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 6, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 7, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 8, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 9, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        ...
        hold_hour_bitget({ hour: 17, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 18, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 19, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 20, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 21, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 22, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 23, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
    } else {
        logCron();
