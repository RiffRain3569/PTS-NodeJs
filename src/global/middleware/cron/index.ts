...
export const cronMiddleware = () => {
    if (process.env.NODE_ENV === 'production') {
        ...
        hold_hour_bitget({ hour: 1, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 2, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 3, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 4, second: 6, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 5, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 6, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 7, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 8, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 9, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 10, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 11, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 12, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 14, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 15, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 16, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 17, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 18, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 19, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 20, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 21, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 22, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
        hold_hour_bitget({ hour: 23, second: 4, duringHour: 1, askPercent: 0.1, position: 'SHORT' });
    } else {
        logCron();
